package com.yinhao.verticaltablayout;
...
import com.yinhao.verticaltablayout.util.DisplayUtil;
import com.yinhao.verticaltablayout.util.TabFragmentManager;
import com.yinhao.verticaltablayout.widget.QTabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_vertical_indicator_color,
                context.getResources().getColor(R.color.colorAccent));
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vertical_indicator_width, DisplayUtil.dp2px(context, 3));
        mIndicatorCorners = typedArray.getDimension(R.styleable.VerticalTabLayout_vertical_indicator_corners, 0);
        mIndicatorGravity = typedArray.getInteger(R.styleable.VerticalTabLayout_vertical_indicator_gravity, Gravity.LEFT);
